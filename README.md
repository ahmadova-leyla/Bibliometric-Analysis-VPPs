...
Reposity containts  dataset, notebook script and plots. Each script can be execute independently on a prefered notebook app (In my experience codes executed faster in jupiter lab 
rather that on google colab). Notebooks files are orginized as follows:
